...
1) ###### GitHub setup
    Fork GitHub Repository by using the existing repo "devops-fully-automated" (https://github.com/Emma-Onye/Fully-Automated-DevOps-Project)     
    - Go to GitHub (github.com)
    - Login to your GitHub Account
    - **Fork repository "devops-fully-automated" (https://github.com/Emma-Onye/Fully-Automated-DevOps-Project) & name it "devops-fully-automated"**
...
2) ###### Jenkins/Maven/Ansible
    ...
    - User data (Copy the following user data): https://github.com/Emma-Onye/Fully-Automated-DevOps-Project/blob/installations/jenkins-maven-ansible-setup.sh
    - Launch Instance
...
3) ###### SonarQube
    ...
    - Key pair: Select or create a new keypair
    - User data (Copy the following user data): https://github.com/Emma-Onye/Fully-Automated-DevOps-Project/blob/installations/sonarqube-setup.sh
    - Launch Instance
...
4) ###### Nexus
    ...
    - Key pair: Select or create a new keypair
    - User data (Copy the following user data): https://github.com/Emma-Onye/Fully-Automated-DevOps-Project/blob/installations/nexus-setup.sh
    - Launch Instance
...
5) ###### EC2 (Dev/Stage/Prod)
    ...
    - Security Group (Open): 8080, 9100 and 22 to 0.0.0.0/0
    - Key pair: Select or create a new keypair
    - User data (Copy the following user data): https://github.com/Emma-Onye/Fully-Automated-DevOps-Project/blob/installations/deployment-servers-setup.sh
    - Launch Instance
...
6) ###### Prometheus
    ...
    - User data (Copy the following user data):https://github.com/Emma-Onye/Fully-Automated-DevOps-Project/blob/installations/prometheus-setup.sh
    - Launch Instance
...
4)  #### Global tools configuration:
    - Click on Manage Jenkins --> Global Tool Configuration
        ...
        **Note:** By default the **Install Oracle Java SE Development Kit from the website** make sure to close that option by clicking on the image as shown below.
        ...
        ![JDKSetup!]https://github.com/Emma-Onye/Fully-Automated-DevOps-Project/blob/main/jdk_setup.png)
